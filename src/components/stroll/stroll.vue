  ...
  <div>
    ...
    <div id="stroll-header"><!---->
      <header id="topbar" class="header">
        <div class="header-content"> <!----> <p class="header-title">闲逛</p></div>
      </header>
    </div>
    <div style="margin-top: 48px;">
      <div class="page-loadmore-wrapper">
        <div class="mint-loadmore">
          <div class="mint-loadmore-content" style="transform: translate3d(0px, 1.33301px, 0px);">
            <div class="mint-loadmore-top"><!----> <span class="mint-loadmore-text">下拉刷新</span></div>
    ...
    <div>
      ...
      <div class="lf-loading" style="display: none;"><i class="lf-circles"></i> <i
          class="iconfont icon-loading-logo"></i></div> <!----></div>
