<template>
  <article id="loginBg" class="acct-wrap" style="margin-top: 0px; overflow: hidden; height: 667px;">
    <div class="old_user_login"><label class="acct_top_back"></label>
          ...
          <div>
            <form id="login-form">
              ...
              <div id="setting" class="set_link">
                <a href="javascript:;"><span>手机号快捷登录</span><b></b></a>
              </div>
            </form>
          </div>
